    ...
    <div class="addComponent" :style="{height:heightAttribute + 'px'}">
        ...
        <div>
            <div style="margin-left: 10px">
                ...
                <input class="mb-2" style="background: white;width: 500px;height: 34px; border-radius: 10px" v-model="data.article" >
                <p class="TextStyle mb-2" style=" color: white;">Название</p>
                <input class="mb-2" style="background: white;width: 500px; height: 34px;border-radius: 10px" v-model="data.name">
                <p class="TextStyle mb-2" style=" color: white;">Статус</p>
                <select class="mb-2" style="background: white;width: 500px; height: 40px;border-radius: 10px" v-model="data.status">
                ...
                <p class="text-white mb-2"> Атрибуты</p>
                    ...
                    <div v-if="attributes" v-for="attribute in attributes" :key="attribute.id">
                        <div class="grid gap-2  grid-cols-3 gap-x-64   w-32 mb-2">
                            ...
                            <div class="mt-6">
                                <svg @click="deleteAttr(attribute)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4" >
            ...
            <button class="bg-sky-500 text-white text-sm rounded-lg w-24 h-6 ml-2 mt-5" @click="addAttributes()">Добавить</button>
        </div>
    </div>
</template>
